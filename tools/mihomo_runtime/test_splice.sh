...
cmp "$root/tools/mihomo_runtime/copy_direct_posix.go" "$source_dir/../sing/common/bufio/copy_direct_posix.go"
cmp "$root/tools/mihomo_runtime/relay.go" "$source_dir/common/net/sing.go"
...
go test -C "$source_dir" -mod=readonly -count=1 -timeout=40s -v "$root/tools/mihomo_runtime/readwait_integration_test.go"
