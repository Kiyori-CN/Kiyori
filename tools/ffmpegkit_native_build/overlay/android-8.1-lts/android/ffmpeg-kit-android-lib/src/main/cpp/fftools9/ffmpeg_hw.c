...
static __thread int nb_hw_devices;
static __thread HWDevice **hw_devices;

void hw_device_execution_state_capture(FFmpegExecutionSharedState *state)
{
    state->hw_devices = hw_devices;
    state->nb_hw_devices = nb_hw_devices;
}

void hw_device_execution_state_bind(const FFmpegExecutionSharedState *state)
{
    hw_devices = state->hw_devices;
    nb_hw_devices = state->nb_hw_devices;
}
