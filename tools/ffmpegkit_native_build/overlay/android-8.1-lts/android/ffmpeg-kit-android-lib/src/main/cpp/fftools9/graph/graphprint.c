...
#include "fftools9/ffmpeg.h"
#include "fftools9/ffmpeg_mux.h"
...
#include "fftools9/textformat/avtextformat.h"
#include "fftools9/textformat/tf_mermaid.h"
#include "fftools9/resources/resman.h"
...
static __thread int prefix_num;

void graphprint_reset_state(void)
{
    prefix_num = 0;
}
