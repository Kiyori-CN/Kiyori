...
export const REMOTE_KIYORI_SETUP_EN_US: RemoteKiyoriSetupI18n = {
  title: "Remote Kiyori Setup",
  subtitle: "Let the current Kiyori call another Kiyori device through the LAN HTTP API.",
  topBanner:
    "Enable External HTTP Chat on the target Kiyori device first, then paste the LAN URL and Bearer token from that screen here.",
  configCardTitle: "Connection Config",
  configCardSubtitle:
    "After saving, this Kiyori can forward chat requests to another Kiyori device. A full http://IP:port URL is recommended.",
  ...
  exampleCardSubtitle:
    "Once enabled, the current Kiyori can forward work to another device. The main entry is remote_kiyori_chat.",
  examplePromptTitle: "Recommended Use",
  examplePromptBody:
    "Use remote_kiyori_chat when the other device has files, apps, permissions, or context that this device does not.",
