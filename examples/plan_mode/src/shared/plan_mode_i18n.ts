export type PlanModeI18n = {
  ...
  toastPlanSubmissionUnknown: string;
...
const ZH_CN: PlanModeI18n = {
  ...
  toastPlanSubmissionUnknown: "此计划已有写入或发送记录，结果尚未确认。请检查聊天和计划文件，避免重复开始实施。",
...
const EN_US: PlanModeI18n = {
  ...
  toastPlanSubmissionUnknown: "This plan already has a write or submission record with an unconfirmed outcome. Check the chat and plan file before starting it again.",
