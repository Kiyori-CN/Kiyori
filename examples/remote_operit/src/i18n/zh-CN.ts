...
export const REMOTE_OPERIT_SETUP_ZH_CN: RemoteOperitSetupI18n = {
  ...
  configCardSubtitle:
    "保存后，当前 Kiyori 就能把聊天请求转发到另一台设备上的 Operit。推荐填写完整的 http://IP:端口。",
  ...
  exampleCardSubtitle:
    "导入并启用后，当前 Kiyori 可以直接把任务转发到另一台设备。常用入口是 remote_operit_chat。",
  examplePromptTitle: "推荐场景",
  examplePromptBody:
    "当另一台设备拥有本机没有的文件、应用、权限或上下文时，让当前 Kiyori 调 remote_operit_chat 去协作。",
