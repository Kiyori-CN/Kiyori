...
export const REMOTE_OPERIT_SETUP_EN_US: RemoteOperitSetupI18n = {
  ...
  configCardSubtitle:
    "After saving, this Kiyori can forward chat requests to another Operit device. A full http://IP:port URL is recommended.",
  ...
  exampleCardSubtitle:
    "Once enabled, the current Kiyori can forward work to another device. The main entry is remote_operit_chat.",
