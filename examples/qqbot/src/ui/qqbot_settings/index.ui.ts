...
function resolveText(): TextBundle {
  ...
  if (locale.startsWith("en")) {
    return {
      ...
      aiTimeoutHint: "Maximum wait time for Kiyori AI to generate a reply.",
      chatGroupLabel: "Kiyori chat group",
      ...
      listenerSwitchDesc: "Keep the QQ Gateway listener running when entering Kiyori.",
  ...
  return {
    ...
    aiTimeoutHint: "等待 Kiyori AI 生成回复的最长时间。",
    chatGroupLabel: "Kiyori 会话分组",
    ...
    listenerSwitchDesc: "进入 Kiyori 时按这个开关恢复 QQ Gateway 监听。",
