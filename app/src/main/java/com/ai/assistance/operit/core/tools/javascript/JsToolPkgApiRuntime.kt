    ...
    return """
        (function() {
            ...
            function parseVersion(value) {
                ...
                var parts = [Number(match[1]), Number(match[2]), Number(match[3])];
                if (parts.some(function(part) { return !Number.isInteger(part) || part > 2147483647; })) {
                    return null;
                }
                return { text: parts.join('.'), parts: parts };
            }
