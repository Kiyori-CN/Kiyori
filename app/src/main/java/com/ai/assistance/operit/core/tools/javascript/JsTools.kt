        ...
        var Tools = {
            ...
            Chat: __operitToolPkgApi.namespace("Tools.Chat", {
                ...
                sendMessage: (message, chatId, roleCardId, senderName, options = {}) => {
                    ...
                    if (options.wait_for_response !== undefined) {
                        if (typeof options.wait_for_response !== "boolean") throw new Error("wait_for_response must be boolean");
                        params.wait_for_response = options.wait_for_response;
                    }
