...
import com.ai.assistance.operit.core.tools.defaultTool.standard.NetworkFileSystemTools
...
fun registerAllTools(handler: AIToolHandler, context: Context) {
    ...
    handler.registerTool(
            ...
            executor = { tool ->
                val characterCardTools = ToolGetter.getCharacterCardSettingsTools(context)
                runBlocking(Dispatchers.IO) { characterCardTools.listCharacterCards(tool) }
            }
    )
    ...
    handler.registerTool(
            ...
            descriptionGenerator = { tool ->
                val characterCardId =
                        tool.parameters.find { it.name == "character_card_id" }?.value ?: ""
                "Get character card settings: $characterCardId"
            },
            executor = { tool ->
                val characterCardTools = ToolGetter.getCharacterCardSettingsTools(context)
                runBlocking(Dispatchers.IO) { characterCardTools.getCharacterCard(tool) }
            }
    )
    ...
    handler.registerTool(
            ...
            executor = { tool ->
                val characterCardTools = ToolGetter.getCharacterCardSettingsTools(context)
                runBlocking(Dispatchers.IO) { characterCardTools.createCharacterCard(tool) }
            }
    )
    ...
    handler.registerTool(
            ...
            executor = { tool ->
                val characterCardTools = ToolGetter.getCharacterCardSettingsTools(context)
                runBlocking(Dispatchers.IO) { characterCardTools.updateCharacterCard(tool) }
            }
    )
    ...
    handler.registerTool(
            ...
            executor = { tool ->
                val characterCardTools = ToolGetter.getCharacterCardSettingsTools(context)
                runBlocking(Dispatchers.IO) { characterCardTools.deleteCharacterCard(tool) }
            }
    )
    ...
    handler.registerTool(
            ...
            executor = { tool ->
                val characterCardTools = ToolGetter.getCharacterCardSettingsTools(context)
                runBlocking(Dispatchers.IO) { characterCardTools.setActiveCharacterCard(tool) }
            }
    )
    ...
    handler.registerTool(
            ...
            executor = { tool ->
                val characterCardTools = ToolGetter.getCharacterCardSettingsTools(context)
                runBlocking(Dispatchers.IO) { characterCardTools.clearActiveCharacterCard(tool) }
            }
    )
    ...
    handler.registerTool(
            ...
            executor = { tool ->
                ...
                runBlocking(Dispatchers.IO) {
                    characterCardTools.importCharacterCardFromTavernJson(tool)
                }
            }
    )
    ...
    handler.registerTool(
            ...
            executor = { tool ->
                val characterCardTools = ToolGetter.getCharacterCardSettingsTools(context)
                runBlocking(Dispatchers.IO) {
                    characterCardTools.exportCharacterCardToTavernJson(tool)
                }
            }
    )
    ...
    handler.registerTool(
            ...
            descriptionGenerator = { tool ->
                s(R.string.toolreg_call_chat_model_desc, tool.parameters.find { it.name == "function_type" }?.value.orEmpty())
            },
