/* METADATA
{
  ...
  display_name: {
    zh: "Kiyori 平台编辑器"
    en: "Kiyori Platform Editor"
  }
  description: {
    zh: '''读取或修改 Kiyori 的 MCP、Skill、Sandbox Package、功能模型、模型参数、上下文总结及 TTS/STT 配置。'''
    en: '''Read or modify Kiyori MCP, Skill, Sandbox Package, function-model, model-parameter, context-summary, and TTS/STT settings.'''
  }
...
- 用户让你排查 Kiyori 的插件配置路径、部署目录、开关状态、环境变量
...
- 再用 `set_context_summary_config` 更新明确传入的上下文总结参数，未传入的设置保持不变；至少提供一项设置。
...
- Use `set_context_summary_config` to update only the supplied context-summary fields; other settings stay unchanged. Supply at least one setting.
...
- Answer with concrete paths/rules from this guide and avoid generic assumptions.'''
    ...
    },
    {
      ...
      description: {
        zh: '''更新某个功能绑定配置的上下文总结参数。至少传入一项设置，未传入的字段保持不变。'''
        en: '''Update context-summary settings for a function binding. Supply at least one setting; omitted fields remain unchanged.'''
      }
      parameters: [
        {
          name: "function_type"
...
const kiyoriEditorPackage = (function () {
    async function kiyori_editor(params) {
        try {
            const { query } = params ?? {};
            complete({
                success: true,
...
6. Practical tip: download an existing skill, extract it directly, and ensure the directory contains SKILL.md`;
    ...
    const TOOLPKG_DEBUG_INSTALL_COMPONENT = "com.kiyori/com.ai.assistance.operit.core.tools.packTool.ToolPkgDebugInstallReceiver";
    ...
    async function resolve_toolpkg_source(rawSourcePath) {
        ...
        if (sourceType === "directory") {
            ...
            const tempExtractDir = path_join(KIYORI_CLEAN_ON_EXIT_DIR, `kiyori_editor_toolpkg_extract_${safe_debug_file_stem(lowerBaseName.replace(/\.toolpkg$/i, ""), "toolpkg")}_${Date.now()}`);
    ...
    function get_error_message(error) {
        // 配置错误可能携带私密参数，日志仅记录失败类型，详细错误通过工具结果返回。
        console.error("[kiyori_editor] Tool operation failed", error instanceof Error ? error.name : typeof error);
        ...
        try {
            ...
            complete({
                ...
                data: {
                    ...
                    model_index: result.modelIndex,
                    actual_model_index: result.actualModelIndex,
    ...
    async function set_context_summary_config(params) {
        try {
            ...
            // 此工具修改已绑定的用户配置；补齐默认值会意外重置未指定的设置。
            const updates = {
            ...
            if (Object.keys(updates).length === 0) {
                complete({ success: false, message: "Supply at least one context-summary setting." });
                return;
            }
            const binding = await Tools.SoftwareSettings.getFunctionModelConfig(functionType);
            const configId = binding.configId.trim();
            if (!configId) {
                complete({
                    success: false,
                    message: `No bound config found for function_type: ${functionType}`,
...
exports.kiyori_editor = kiyoriEditorPackage.kiyori_editor;
exports.how_make_skill = kiyoriEditorPackage.how_make_skill;
exports.list_sandbox_packages = kiyoriEditorPackage.list_sandbox_packages;
exports.set_sandbox_package_enabled = kiyoriEditorPackage.set_sandbox_package_enabled;
exports.debug_install_js_package = kiyoriEditorPackage.debug_install_js_package;
exports.debug_install_toolpkg = kiyoriEditorPackage.debug_install_toolpkg;
exports.debug_run_sandbox_script = kiyoriEditorPackage.debug_run_sandbox_script;
exports.read_environment_variable = kiyoriEditorPackage.read_environment_variable;
exports.write_environment_variable = kiyoriEditorPackage.write_environment_variable;
exports.restart_mcp_with_logs = kiyoriEditorPackage.restart_mcp_with_logs;
exports.get_speech_services_config = kiyoriEditorPackage.get_speech_services_config;
exports.set_speech_services_config = kiyoriEditorPackage.set_speech_services_config;
exports.test_tts_playback = kiyoriEditorPackage.test_tts_playback;
exports.list_model_configs = kiyoriEditorPackage.list_model_configs;
exports.create_model_config = kiyoriEditorPackage.create_model_config;
exports.update_model_config = kiyoriEditorPackage.update_model_config;
exports.delete_model_config = kiyoriEditorPackage.delete_model_config;
exports.list_function_model_configs = kiyoriEditorPackage.list_function_model_configs;
exports.get_function_model_config = kiyoriEditorPackage.get_function_model_config;
exports.get_context_summary_config = kiyoriEditorPackage.get_context_summary_config;
exports.set_context_summary_config = kiyoriEditorPackage.set_context_summary_config;
exports.set_function_model_config = kiyoriEditorPackage.set_function_model_config;
exports.test_model_config_connection = kiyoriEditorPackage.test_model_config_connection;
exports.ping_mcp = kiyoriEditorPackage.ping_mcp;
