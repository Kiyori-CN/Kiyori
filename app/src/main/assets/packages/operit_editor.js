/* METADATA
{
  ...
  description: {
    zh: '''读取或修改 Operit 的 MCP、Skill、Sandbox Package、功能模型、模型参数、上下文总结及 TTS/STT 配置。'''
    en: '''Read or modify Operit MCP, Skill, Sandbox Package, function-model, model-parameter, context-summary, and TTS/STT settings.'''
  }
