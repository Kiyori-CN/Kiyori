...
step: 10
depends_on:
  - 09_variants_signing_and_versioning.md
...
[上一步：变体、调试边界、签名与版本身份](./09_variants_signing_and_versioning.md) · [返回总计划](./index.md) · [下一步：APK 审计与补丁链](./11_apk_audit_and_patch.md)
