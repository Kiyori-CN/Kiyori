...
step: 8
depends_on:
  - 07_android_capability_contracts.md
...
[上一步：Android 能力契约](./07_android_capability_contracts.md) · [返回总计划](./index.md) · [下一步：变体、签名与版本身份](./09_variants_signing_and_versioning.md)
