...
step: 9
depends_on:
  - 08_feature_module_isolation.md
...
[上一步：Feature 模块隔离](./08_feature_module_isolation.md) · [返回总计划](./index.md) · [下一步：调试接口注册与数据救援 Shell](./10_debug_interface_registry_and_data_rescue_shell.md)
