...
step: 3
depends_on:
  - 02_js_workspace_and_lockfile.md
...
[上一步：pnpm workspace 与锁文件](./02_js_workspace_and_lockfile.md) · [返回总计划](./index.md) · [下一步：Gradle 输入规范化](./04_gradle_input_normalization.md)
