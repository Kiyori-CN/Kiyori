...
新增或修复的用户可见行为，不替代 `03_target_data_and_protocol_contract.md`、
`04_ui_information_architecture.md` 和 `05_reasoning_and_codex_tiers.md` 中仍然有效的
数据、兼容和执行合同。
...
`09_auto_detection_removal_drawer_unification_and_responses_tools.md`。
