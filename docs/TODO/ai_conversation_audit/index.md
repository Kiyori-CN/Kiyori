...
- [2026-09-08 删除唯一对话崩溃修复](#2026-09-08-删除唯一对话崩溃修复)
- [1. 目标与权威边界](#1-目标与权威边界)
- [2. 非目标](#2-非目标)
- [3. 冻结产品合同](#3-冻结产品合同)
- [4. 数据模型](#4-数据模型)
- [5. 加密 payload 与原子性](#5-加密-payload-与原子性)
- [6. 事件分类](#6-事件分类)
- [7. 写入接线](#7-写入接线)
- [8. 历史聊天重建](#8-历史聊天重建)
- [9. 导入、导出与备份](#9-导入导出与备份)
- [10. UI 实现](#10-ui-实现)
- [11. 文档同步](#11-文档同步)
- [12. 串行实施阶段](#12-串行实施阶段)
- [13. 自动验证矩阵](#13-自动验证矩阵)
- [14. 风险](#14-风险)
- [15. 当前验收状态](#15-当前验收状态)
- [16. 2026-08-30 诊断中心 UI 与明文 AI 导出优化](#16-2026-08-30-诊断中心-ui-与明文-ai-导出优化)
- [17. 2026-08-30 无引用 payload 回收并发修复](#17-2026-08-30-无引用-payload-回收并发修复)
