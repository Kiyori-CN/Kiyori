...
- [2026-09-07：AI 创建与管理浏览器扩展、脚本](#2026-09-07ai-创建与管理浏览器扩展脚本)
- [1. 目标](#1-目标)
- [2. 2026-07-31 历史基线](#2-2026-07-31-历史基线)
- [2.1 已确认的本轮产品决策](#21-已确认的本轮产品决策)
- [2.2 二次深度收口计划（2026-07-31）](#22-二次深度收口计划2026-07-31)
- [2.3 真实脚本异常与浏览器设置收口（2026-07-31）](#23-真实脚本异常与浏览器设置收口2026-07-31)
- [2.4 插件中心信息架构与日志交互（2026-07-31）](#24-插件中心信息架构与日志交互2026-07-31)
- [2.5 网页 Cookie 内置插件（2026-09-02）](#25-网页-cookie-内置插件2026-09-02)
- [3. 全局不变量](#3-全局不变量)
- [4. Phase 0：运行时安全和可行性](#4-phase-0运行时安全和可行性)
- [5. Phase 1：userscript 管理闭环](#5-phase-1userscript-管理闭环)
- [6. Phase 2：Provider 驱动插件中心](#6-phase-2provider-驱动插件中心)
- [7. Phase 3：`.kbx` 包与安装器](#7-phase-3kbx-包与安装器)
- [8. Phase 4：content-only 扩展](#8-phase-4content-only-扩展)
- [9. Phase 5：background worker](#9-phase-5background-worker)
- [10. Phase 6：签名、catalog 和更新](#10-phase-6签名catalog-和更新)
- [11. Phase 7：AI 创作](#11-phase-7ai-创作)
- [12. Phase 8：WebExtension 兼容](#12-phase-8webextension-兼容)
- [13. 每阶段收尾](#13-每阶段收尾)
- [14. 当前下一步](#14-当前下一步)
...
6. [DONE] 精确允许清单审阅、候选提交检查、提交推送并核对本地/跟踪/远端 SHA。
