...
[`../kiyori_home_ui_refresh/02_weather_and_browser_windows.md`](../kiyori_home_ui_refresh/02_weather_and_browser_windows.md)
为准，搜索交互细节仍以
[`../kiyori_browser_product_completion/02_software_home_and_fullscreen_search.md`](../kiyori_browser_product_completion/02_software_home_and_fullscreen_search.md)
为准。
