...
- [终端子模块](#终端子模块)
- [继续覆盖的控制面](#继续覆盖的控制面)
- [P6a 已展开叶子与当前证据](#p6a-已展开叶子与当前证据)
- [P6a 终端叶子审查队列](#p6a-终端叶子审查队列)
- [P6b 对话详情叶子覆盖](#p6b-对话详情叶子覆盖)
- [P6a 路径、配置与预览补充覆盖](#p6a-路径配置与预览补充覆盖)
- [P6c 环境配置首批覆盖](#p6c-环境配置首批覆盖)
- [P6c Skill 详情增量](#p6c-skill-详情增量)
- [P6c MCP 覆盖与剩余反审](#p6c-mcp-覆盖与剩余反审)
- [P6c 市场安装与评论增量](#p6c-市场安装与评论增量)
- [P6d 工具箱首批](#p6d-工具箱首批)
- [P6e–P6g 反审顺序](#p6ep6g-反审顺序)
