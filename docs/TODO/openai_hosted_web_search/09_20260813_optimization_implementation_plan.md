...
- [9.1 最终结论](#91-最终结论)
- [9.2 问题优先级](#92-问题优先级)
- [9.3 复现路径与根因模型](#93-复现路径与根因模型)
- [9.4 目标请求生命周期](#94-目标请求生命周期)
- [9.5 Admission 与预算设计](#95-admission-与预算设计)
- [9.6 配置架构：只保留 `PACKAGE_ENV`](#96-配置架构只保留-package_env)
- [9.7 Provider 设置 UI](#97-provider-设置-ui)
- [9.8 搜索结果卡片](#98-搜索结果卡片)
- [9.9 Evidence parser 可观察性](#99-evidence-parser-可观察性)
- [9.10 `User-Agent` 与 headers](#910-user-agent-与-headers)
- [9.11 流式与 background 后续里程碑](#911-流式与-background-后续里程碑)
- [9.12 候选文件](#912-候选文件)
- [9.13 测试矩阵](#913-测试矩阵)
- [9.14 实施顺序](#914-实施顺序)
- [9.15 非目标](#915-非目标)
- [9.16 正式编码前门禁](#916-正式编码前门禁)
