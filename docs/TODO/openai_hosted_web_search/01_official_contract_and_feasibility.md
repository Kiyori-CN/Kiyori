...
- [1.1 研究范围](#11-研究范围)
- [1.2 Codex 产品配置](#12-codex-产品配置)
- [1.3 Responses 托管 Web Search](#13-responses-托管-web-search)
- [1.4 为什么它仍然是模型请求](#14-为什么它仍然是模型请求)
- [1.5 模型支持](#15-模型支持)
- [1.6 `gpt-5-search-api`](#16-gpt-5-search-api)
- [1.7 Codex standalone search](#17-codex-standalone-search)
- [1.8 Responses-compatible 中转站](#18-responses-compatible-中转站)
- [1.9 可行性矩阵](#19-可行性矩阵)
- [1.10 与 Codex 的相似度边界](#110-与-codex-的相似度边界)
- [1.11 定价边界](#111-定价边界)
