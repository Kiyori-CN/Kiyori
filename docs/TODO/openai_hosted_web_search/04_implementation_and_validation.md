...
- [4.1 当前状态与授权边界](#41-当前状态与授权边界)
- [4.2 Revision 7 本地实现与验证](#42-revision-7-本地实现与验证)
- [4.3 Revision 6 历史基线](#43-revision-6-历史基线)
- [4.4 自动验证矩阵](#44-自动验证矩阵)
- [4.5 Revision 7 当前 APK 审计](#45-revision-7-当前-apk-审计)
- [4.6 历史 revision 3–5 证据](#46-历史-revision-35-证据)
- [4.7 待验证](#47-待验证)
- [4.8 2026-08-13 现场矩阵](#48-2026-08-13-现场矩阵)
- [4.9 最新现场日志与 hotfix 验收边界](#49-最新现场日志与-hotfix-验收边界)
...
[专项索引](index.md)、[日志深度分析](06_log_deep_analysis_20260812.md) 与
[后续修复计划](07_log_followup_fix_plan_20260812.md)。
