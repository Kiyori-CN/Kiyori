...
- [2.1 设计目标](#21-设计目标)
- [2.2 候选方案](#22-候选方案)
- [2.3 最终组件关系](#23-最终组件关系)
- [2.4 宿主职责](#24-宿主职责)
- [2.5 ToolPkg 职责](#25-toolpkg-职责)
- [2.6 搜索工具参数](#26-搜索工具参数)
- [2.7 设置页](#27-设置页)
- [2.8 与当前 Kiyori 代码的连接点](#28-与当前-kiyori-代码的连接点)
- [2.9 为什么不直接调用 `OpenAIResponsesProvider`](#29-为什么不直接调用-openairesponsesprovider)
- [2.10 后续原生模式](#210-后续原生模式)
