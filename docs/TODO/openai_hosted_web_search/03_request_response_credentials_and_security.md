...
- [3.1 API Key 是否与主模型共用](#31-api-key-是否与主模型共用)
- [3.2 当前 Kiyori 凭据边界](#32-当前-kiyori-凭据边界)
- [3.3 服务绑定数据模型](#33-服务绑定数据模型)
- [3.4 第一版请求合同](#34-第一版请求合同)
- [3.5 请求字段策略](#35-请求字段策略)
- [3.6 输出合同](#36-输出合同)
- [3.7 citation 与主模型改写](#37-citation-与主模型改写)
- [3.8 source 规范化](#38-source-规范化)
- [3.9 错误合同](#39-错误合同)
- [3.10 超时、取消、并发与重试](#310-超时取消并发与重试)
- [3.11 Prompt Injection](#311-prompt-injection)
- [3.12 OpenAI 项目与认证资料](#312-openai-项目与认证资料)
