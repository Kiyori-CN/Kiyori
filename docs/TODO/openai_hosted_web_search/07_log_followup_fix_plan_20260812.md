...
based_on: 06_log_deep_analysis_20260812.md
...
- [1. 计划目标](#1-计划目标)
- [2. 实施顺序与门禁](#2-实施顺序与门禁)
- [2.1 当前实施快照](#21-当前实施快照)
- [2.2 W7：最终本地验证与制品审计证据](#22-w7最终本地验证与制品审计证据)
- [3. W0：准备与保护边界](#3-w0准备与保护边界)
- [4. W1：Responses 传输诊断与未知状态定位](#4-w1responses-传输诊断与未知状态定位)
- [5. W2：请求日志与凭据隐私修复](#5-w2请求日志与凭据隐私修复)
- [6. W3：错误所有权与日志降噪](#6-w3错误所有权与日志降噪)
- [7. W4：AIForegroundService 生命周期取消](#7-w4aiforegroundservice-生命周期取消)
- [8. W5：UIHierarchyManager 绑定合同](#8-w5uihierarchymanager-绑定合同)
- [9. W6：启动性能观测和决策](#9-w6启动性能观测和决策)
- [10. W7：本地验证矩阵](#10-w7本地验证矩阵)
- [11. W8：relay 与设备验收](#11-w8relay-与设备验收)
- [12. 风险、恢复与停止条件](#12-风险恢复与停止条件)
...
本计划把
[日志深度分析](06_log_deep_analysis_20260812.md)
