...
- 模态 AI 左抽屉的无手势容器、一级页面状态、AI 设置双来源返回和原版信息密度已实现；高频入口为“扩展 / 工具箱 / 工作流”，工具箱不再显示文件管理器与协议 host entry；“设置 - 更多功能”现在按“权限 / 网络代理 / 开源协议 / 用户协议 / 隐私政策”进入各自 owner
...
- “设置 - 更多功能”五项入口分别进入权限、网络代理、开源协议、用户协议和隐私政策；两份法律文档只读复用现行版本源，Back 先回更多功能
