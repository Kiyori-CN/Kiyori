...
- 检查主题设置不再提供全局颜色、AppBar 颜色或前景色入口
- 检查角色主题键只包含 AI 局部外观，并确认浏览器状态 owner 未改变
...
- 设置首页、拆分设置根和关键子页使用统一浅色设置 token 与语义彩色图标
...
- 背景图片/视频只影响 AI 对话，不改变设置、工具页或应用壳
- 玻璃输入、自定义气泡、头像和聊天头部设置继续工作
- AI 局部字体与气泡字体不改变全局设置文字
- 全局字体和字体缩放不裁切顶栏、消息、地址栏和按钮
