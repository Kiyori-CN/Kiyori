...
- [9. 缓存失效矩阵](#9-缓存失效矩阵)
- [10. 订阅刷新事务](#10-订阅刷新事务)
- [11. 自定义规则边界](#11-自定义规则边界)
- [12. 内存、磁盘与稳定性约束](#12-内存磁盘与稳定性约束)
- [13. 运行时可观测性](#13-运行时可观测性)
- [14. 实际实施文件范围](#14-实际实施文件范围)
...
- [19. 风险与控制](#19-风险与控制)
- [20. 完成定义](#20-完成定义)
- [21. 2026-08-18 本地实施记录](#21-2026-08-18-本地实施记录)
- [22. 2026-08-20 广告订阅编译 OOM 根因修复](#22-2026-08-20-广告订阅编译-oom-根因修复)
- [23. 2026-09-03 自动刷新域集合内存峰值修复计划](#23-2026-09-03-自动刷新域集合内存峰值修复计划)
...
- `CONTEXT.md`
- `docs/TODO/README.md`
- `docs/TODO/kiyori_browser_product_completion/07_browser_menu_capabilities.md`
- 本文
