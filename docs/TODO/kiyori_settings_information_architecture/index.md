...
- [2026-08-20 AI助手设置全面重构](#2026-08-20-ai助手设置全面重构)
- [2026-08-20 文件管理器与法律文档入口收口](#2026-08-20-文件管理器与法律文档入口收口)
- [2026-08-20 设置首页四组三项重排与子页面统一优化](#2026-08-20-设置首页四组三项重排与子页面统一优化)
- [历史基线（已由 2026-08-20 方案取代）](#历史基线已由-2026-08-20-方案取代)
- [信息归属](#信息归属)
- [视觉合同](#视觉合同)
- [串行实施](#串行实施)
- [验收边界](#验收边界)
