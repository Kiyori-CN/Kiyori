...
- [2026-08-28 最新安装回归修复](#2026-08-28-最新安装回归修复)
- [目标与完成标准](#目标与完成标准)
- [2026-08-28 规则管理与站点代理禁用方案](#2026-08-28-规则管理与站点代理禁用方案)
- [当前实施状态](#当前实施状态)
- [2026-08-27 在线播放、启动代理与脚本规则重构方案](#2026-08-27-在线播放启动代理与脚本规则重构方案)
- [2026-08-24 规则模式网页与播放器链路修复](#2026-08-24-规则模式网页与播放器链路修复)
- [本轮规则模式设计（2026-08-24）](#本轮规则模式设计2026-08-24)
- [非目标](#非目标)
- [现场错误与根因证据](#现场错误与根因证据)
- [唯一状态所有者](#唯一状态所有者)
- [持久化模型](#持久化模型)
- [Mihomo 配置与策略组](#mihomo-配置与策略组)
- [内嵌核心与安全](#内嵌核心与安全)
- [外部 Clash / 系统 VPN 共存](#外部-clash--系统-vpn-共存)
- [设置页面设计](#设置页面设计)
- [失败语义](#失败语义)
- [实施顺序](#实施顺序)
- [自动验证矩阵](#自动验证矩阵)
- [2026-08-23 深度优化实施方案](#2026-08-23-深度优化实施方案)
- [真机验收](#真机验收)
- [2026-08-23 应用级路由闭环修订](#2026-08-23-应用级路由闭环修订)
- [2026-08-23 Mihomo runtime 生命周期修订](#2026-08-23-mihomo-runtime-生命周期修订)
- [2026-08-23 代理运行时诊断链路增强](#2026-08-23-代理运行时诊断链路增强)
- [2026-08-23 异常自然退出自动恢复](#2026-08-23-异常自然退出自动恢复)
- [2026-08-24 最终收口与交付候选](#2026-08-24-最终收口与交付候选)
