...
本文保存文档体系整理前的完整工程收口计划与验证快照，迁移基线为 `145f378900d663b812d9df3c73de15fbad56139c`。正文中的“本轮”“当前”“已通过”仅对应原记录；明确日期以各条目为准，未标日期的聚合证据不推断为本次验证。

当前要求与五份验收清单见 [正式开发准备](index.md)。历史中的 APK、测试计数、远端 CI 与子模块身份不可直接复用为新提交的验收结果。
