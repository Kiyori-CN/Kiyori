...
- 自动门禁：2026-07-23 使用项目 `.venv` 执行正式准备检查通过，完整 Python 测试 `48/48`、其中 Android dependency 测试 `11/11` 通过；强制 Kotlin 复采为 436 条既有 warning，最终 Lint 为 38 warnings + 2 hints，baseline 未修改。本轮高风险候选、产品壳新增告警、PrivateResource 和旧 library manifest 告警均已修复
