...
- Debug 构建：`2026-07-27 13:31:19 +08:00` 的 APK 为 `app/build/outputs/apk/debug/app-debug.apk`，大小 `449493090` 字节，包名 `com.kiyori`，版本 `45 / 0.1.0`，SHA-256 为 `89CADC2171FC9B07202F9CB084CBC87F2A48ECB7AA17BBA830978C38AF5C924C`。APK 使用 Android Debug V2 签名且 `zipalign -c -P 16 -v 4` 通过；`lib/arm64-v8a/liboperit_ripgrep.so` 已由 Gradle 生成并打包，剥离后 SHA-256 为 `5A84187EE5945B1ABE1E534ADCB48DE6A77119B01F2A8B6176380E97B66AF311`，四个 `PT_LOAD` 均为 `0x4000`。生产 ToolPkg 与品牌资产沿用此前完整审计结论；真机 Launcher、系统文件选择器、快捷方式、通知、Terminal、PNPM 检测、ripgrep 搜索和悬浮浏览器 Back 仍待执行
