...
详细根因、影响文件、风险、回滚点和验收矩阵见 [`kiyori_browser_product_completion/09_browser_sniffer_and_floating_playback.md`](../../kiyori_browser_product_completion/09_browser_sniffer_and_floating_playback.md) 的“2026-08-27 悬浮播放器关闭后重弹与跨页旧媒体重播修复”。
