...
| C-01 | 修复基线契约失配，恢复可信架构/JVM/Lint检查 | 资源/导航批次本地验证：92 JVM、272 Python、Debug/APK；架构 19→16→12，无新增；Lint 55 缺译错误及 35 无用资源警告已清除，标签数 plurals 已入 APK；其余 Manifest/主题合同与最终 Lint 继续实施 |
