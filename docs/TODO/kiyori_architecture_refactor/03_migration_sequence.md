...
- [总规则](#总规则)
- [阶段 0：方案确认](#阶段-0方案确认)
- [阶段 1：正式实施基线与安全点](#阶段-1正式实施基线与安全点)
- [阶段 1.5：G-00 架构与稳定合同门禁基线](#阶段-15g-00-架构与稳定合同门禁基线)
- [阶段 2：应用根命名与包边界](#阶段-2应用根命名与包边界)
- [阶段 3：设计系统与平台能力](#阶段-3设计系统与平台能力)
- [阶段 4：Browser 产品域](#阶段-4browser-产品域)
- [阶段 5：Player 产品域](#阶段-5player-产品域)
- [阶段 6：设置、文件、备份与其他产品域](#阶段-6设置文件备份与其他产品域)
- [阶段 7：Operit AI 集成收口](#阶段-7operit-ai-集成收口)
- [阶段 8：依赖门禁与模块化决策](#阶段-8依赖门禁与模块化决策)
- [阶段 9：可选 namespace 与组件名迁移](#阶段-9可选-namespace-与组件名迁移)
