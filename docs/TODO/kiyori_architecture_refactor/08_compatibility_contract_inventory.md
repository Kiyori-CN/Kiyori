...
- [目的](#目的)
- [Android 身份](#android-身份)
- [Room、ObjectBox 与备份](#roomobjectbox-与备份)
- [启动通知权限](#启动通知权限)
- [DataStore 与 SharedPreferences](#datastore-与-sharedpreferences)
- [Web、Player 与产品公共路径](#webplayer-与产品公共路径)
- [Serialization 与 reflection](#serialization-与-reflection)
- [WorkManager](#workmanager)
- [Manifest、资源和外部组件](#manifest资源和外部组件)
- [AIDL、JNI 与 native](#aidljni-与-native)
- [Operit ecosystem](#operit-ecosystem)
- [合同变更流程](#合同变更流程)
