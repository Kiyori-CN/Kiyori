...
| `ARCH041` | M-05A2 semantic color/Compose adapter owner 缺失，旧/new 双 owner、枚举/色值/稳定 ID/底栏/天气/luminance 合同、55 个消费者、99 条 import、测试所有权或 ARCH025/026/027 snapshot 发生漂移 | error |
