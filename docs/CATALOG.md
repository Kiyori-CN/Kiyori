...
本页由 `ci/script/check_documentation.py --write-catalogs` 生成。按主题查阅请先进入 [文档中心](README.md)。只收录父仓库维护的文档；子模块文档由各自仓库维护。

## .github

| 文档 | 用途或标题 |
| --- | --- |
| [PULL_REQUEST_TEMPLATE.md](../.github/PULL_REQUEST_TEMPLATE.md) | 变更说明 |

## app/src/main/assets

| 文档 | 用途或标题 |
| --- | --- |
| [README.md](../app/src/main/assets/README.md) | 内置 Shizuku APK 说明 |

## app/src/main/assets/templates/android

| 文档 | 用途或标题 |
| --- | --- |
| [README.md](../app/src/main/assets/templates/android/README.md) | Kiyori Android 项目 |

## app/src/main/assets/templates/flutter

| 文档 | 用途或标题 |
| --- | --- |
| [README.md](../app/src/main/assets/templates/flutter/README.md) | Kiyori Flutter 项目 |

## app/src/main/assets/templates/flutter/ios/Runner/Assets.xcassets/LaunchImage.imageset

| 文档 | 用途或标题 |
| --- | --- |
| [README.md](../app/src/main/assets/templates/flutter/ios/Runner/Assets.xcassets/LaunchImage.imageset/README.md) | Launch Screen Assets |

## app/src/main/assets/templates/go

| 文档 | 用途或标题 |
| --- | --- |
| [README.md](../app/src/main/assets/templates/go/README.md) | Kiyori Go 项目 |

## app/src/main/assets/templates/java

| 文档 | 用途或标题 |
| --- | --- |
| [README.md](../app/src/main/assets/templates/java/README.md) | Kiyori Java 项目 |

## app/src/main/assets/templates/node

| 文档 | 用途或标题 |
| --- | --- |
| [README.md](../app/src/main/assets/templates/node/README.md) | Kiyori Node.js 项目 |

## app/src/main/assets/templates/office
...
| 文档 | 用途或标题 |
| --- | --- |
| [README.md](../app/src/main/assets/templates/python/README.md) | Kiyori Python 项目 |

## app/src/main/assets/templates/typescript

| 文档 | 用途或标题 |
| --- | --- |
| [README.md](../app/src/main/assets/templates/typescript/README.md) | Kiyori TypeScript 项目 |

## app/src/main/cpp/streamnative

| 文档 | 用途或标题 |
| --- | --- |
| [README.md](../app/src/main/cpp/streamnative/README.md) | Native 流处理模块 |
| [kmpREADME.md](../app/src/main/cpp/streamnative/kmpREADME.md) | Native KMP 匹配模块 |

## app/src/main/java/com/ai/assistance/operit/core/tools/javascript

| 文档 | 用途或标题 |
| --- | --- |
| [README.md](../app/src/main/java/com/ai/assistance/operit/core/tools/javascript/README.md) | Script 开发指南 |

## app/src/main/java/com/ai/assistance/operit/ui/features/chat/components/lazy

| 文档 | 用途或标题 |
| --- | --- |
| [README.md](../app/src/main/java/com/ai/assistance/operit/ui/features/chat/components/lazy/README.md) | 本地 LazyColumn 实现 |

## app/src/main/java/com/ai/assistance/operit/util/stream
...
| 文档 | 用途或标题 |
| --- | --- |
| [README.md](../ci/README.md) | CI 检查与验证指南 |

## config/architecture

| 文档 | 用途或标题 |
| --- | --- |
| [README.md](../config/architecture/README.md) | 架构边界控制面 |

## docs

| 文档 | 用途或标题 |
| --- | --- |
| [README.md](README.md) | Kiyori 文档中心 |
| [SCRIPT_DEV_GUIDE.md](SCRIPT_DEV_GUIDE.md) | 脚本开发指南 |
| [SCRIPT_DEV_SKILL.md](SCRIPT_DEV_SKILL.md) | Sandbox Package 开发技能说明 |
| [TOOLPKG_FORMAT_GUIDE.md](TOOLPKG_FORMAT_GUIDE.md) | ToolPkg 格式说明文档 |

## docs/TODO

| 文档 | 用途或标题 |
| --- | --- |
| [README.md](TODO/README.md) | Kiyori 开发任务索引 |

## docs/TODO/academic_script_catalog

| 文档 | 用途或标题 |
| --- | --- |
| [index.md](TODO/academic_script_catalog/index.md) | Academic 学术脚本分组与五源 API |

## docs/TODO/agreement_version_confirmation
...
| 文档 | 用途或标题 |
| --- | --- |
| [index.md](TODO/ai_chat_rendering_reliability/index.md) | AI 对话渲染可靠性与工具内容边界 |

## docs/TODO/ai_conversation_audit

| 文档 | 用途或标题 |
| --- | --- |
| [index.md](TODO/ai_conversation_audit/index.md) | AI 对话详情与完整审计 |

## docs/TODO/ai_interrupted_turn_recovery

| 文档 | 用途或标题 |
| --- | --- |
| [index.md](TODO/ai_interrupted_turn_recovery/index.md) | AI 中断后会话损坏：根因、回合收口与恢复方案 |

## docs/TODO/ai_model_tag_management
...
| 文档 | 用途或标题 |
| --- | --- |
| [index.md](TODO/application_network_proxy/index.md) | Kiyori 应用级网络代理与内嵌 Mihomo |

## docs/TODO/bilibili_toolkit

| 文档 | 用途或标题 |
| --- | --- |
| [index.md](TODO/bilibili_toolkit/index.md) | 哔哩哔哩工具包内置 ToolPkg |

## docs/TODO/browser_plugin_platform

| 文档 | 用途或标题 |
| --- | --- |
| [index.md](TODO/browser_plugin_platform/index.md) | 浏览器插件平台实施计划 |

## docs/TODO/builtin_script_plugin_standardization

| 文档 | 用途或标题 |
| --- | --- |
| [index.md](TODO/builtin_script_plugin_standardization/index.md) | 内置脚本与插件规范化 |

## docs/TODO/character_card_prompt_ui

| 文档 | 用途或标题 |
| --- | --- |
| [index.md](TODO/character_card_prompt_ui/index.md) | 角色卡和提示词页面与环境识别修复 |

## docs/TODO/code_runner_terminal_toolchain
...
| 文档 | 用途或标题 |
| --- | --- |
| [index.md](TODO/ffmpeg_runtime_completion/index.md) | FFmpeg 运行时完善计划 |

## docs/TODO/formal_development_readiness
...
| 文档 | 用途或标题 |
| --- | --- |
| [index.md](TODO/home_pager_gesture_consistency/index.md) | 三页首页横向手势一致性修复 |

## docs/TODO/issue_767_avatar_config_persistence

| 文档 | 用途或标题 |
| --- | --- |
| [index.md](TODO/issue_767_avatar_config_persistence/index.md) | Issue 767 头像配置持久化修复 |
...
| [13_architecture_guard_specification.md](TODO/kiyori_architecture_refactor/13_architecture_guard_specification.md) | 架构门禁与机器可读所有权规范 |
| [14_validation_command_catalog.md](TODO/kiyori_architecture_refactor/14_validation_command_catalog.md) | 验证命令目录 |
| [15_m01_application_rename_exact_manifest.md](TODO/kiyori_architecture_refactor/15_m01_application_rename_exact_manifest.md) | M-01 Application 原包改名精确影响清单 |
| [16_m00_document_authority_update_manifest.md](TODO/kiyori_architecture_refactor/16_m00_document_authority_update_manifest.md) | M-00 权威文档同步精确清单 |
...
| 文档 | 用途或标题 |
| --- | --- |
| [index.md](TODO/kiyori_browser_force_zoom/index.md) | 强制页面缩放与 UA 适配 |

## docs/TODO/kiyori_browser_home_websession
...
| 文档 | 用途或标题 |
| --- | --- |
| [index.md](TODO/kiyori_browser_navigation_and_session_restoration/index.md) | 设置返回、浏览器窗口与会话恢复方案 |

## docs/TODO/kiyori_browser_product_completion
...
| [13_player_online_playback_reliability_and_compatibility.md](TODO/kiyori_browser_product_completion/13_player_online_playback_reliability_and_compatibility.md) | 在线视频播放可靠性、兼容性与快速启动方案 |
| [14_player_native_dependency_upgrade.md](TODO/kiyori_browser_product_completion/14_player_native_dependency_upgrade.md) | 播放器原生依赖升级与 closure 迁移 |
| [15_adblock_compiled_runtime_cache.md](TODO/kiyori_browser_product_completion/15_adblock_compiled_runtime_cache.md) | 广告拦截编译快照与启动缓存方案 |
| [16_browser_runtime_diagnostics_and_menu_optimization.md](TODO/kiyori_browser_product_completion/16_browser_runtime_diagnostics_and_menu_optimization.md) | 浏览器运行时诊断与菜单优化 |
...
| 文档 | 用途或标题 |
| --- | --- |
| [index.md](TODO/kiyori_extension_script_brand_migration/index.md) | Kiyori 扩展脚本品牌与运行契约迁移 |

## docs/TODO/kiyori_first_run_experience
...
| 文档 | 用途或标题 |
| --- | --- |
| [index.md](TODO/kiyori_onboarding_first_run/index.md) | 首次安装启动体验重做 |
...
| 文档 | 用途或标题 |
| --- | --- |
| [index.md](TODO/kiyori_runtime_environment_crash_fixes/index.md) | 环境检测与运行时崩溃修复 |

## docs/TODO/kiyori_settings_information_architecture

| 文档 | 用途或标题 |
| --- | --- |
| [index.md](TODO/kiyori_settings_information_architecture/index.md) | 设置页信息架构与统一视觉 |

## docs/TODO/kiyori_settings_theme_unification
...
| 文档 | 用途或标题 |
| --- | --- |
| [index.md](TODO/kiyori_shizuku_privileged_execution_and_log_migration/index.md) | Shizuku 特权执行与日志命名迁移 |

## docs/TODO/kiyori_startup_performance
...
| 文档 | 用途或标题 |
| --- | --- |
| [index.md](TODO/operit_1_12_1_ai_update/index.md) | Operit v1.12.1 必要 AI 插件发布更新 |

## docs/TODO/operit_post_1_12_1_sync
...
| 文档 | 用途或标题 |
| --- | --- |
| [index.md](TODO/search_script_standardization/index.md) | Search 内置脚本规范化与四家官方 API 完善 |

## docs/TODO/toolpkg_assemblyscript_wasm

| 文档 | 用途或标题 |
| --- | --- |
| [index.md](TODO/toolpkg_assemblyscript_wasm/index.md) | ToolPkg AssemblyScript WASM 模块接入 |

## docs/TODO/toolpkg_engine_timeout
...
| 文档 | 用途或标题 |
| --- | --- |
| [index.md](TODO/toolpkg_protection_ast_minify/index.md) | ToolPkg AST 压缩 |

## docs/TODO/tools_directory_reorganization
...
| 文档 | 用途或标题 |
| --- | --- |
| [01_full_inventory.md](TODO/ui_style_unification/01_full_inventory.md) | UI 全量盘点与验收矩阵 |
| [index.md](TODO/ui_style_unification/index.md) | 全软件 UI 风格统一优化 |

## docs/TODO/unified_model_capability_and_resumable_execution
...
| [network_proxy.md](doc-src/contracts/network_proxy.md) | 应用网络路由契约 |
| [platform_storage.md](doc-src/contracts/platform_storage.md) | 平台、存储与服务生命周期契约 |
| [product_shell.md](doc-src/contracts/product_shell.md) | 应用壳、导航与设置契约 |

## docs/doc-src/decisions

| 文档 | 用途或标题 |
| --- | --- |
| [0001_kiyori_product_positioning.md](doc-src/decisions/0001_kiyori_product_positioning.md) | Kiyori 产品定位与 Operit AI 边界 |
| [0002_product_shell_and_ai_center_navigation.md](doc-src/decisions/0002_product_shell_and_ai_center_navigation.md) | 产品壳与 AI 中心导航 |
| [0003_ui_design_source_hierarchy.md](doc-src/decisions/0003_ui_design_source_hierarchy.md) | UI 设计来源层级 |
| [0004_modal_ai_drawer_navigation.md](doc-src/decisions/0004_modal_ai_drawer_navigation.md) | 模态 AI 左抽屉导航 |
| [0005_browser_home_immersive_chrome.md](doc-src/decisions/0005_browser_home_immersive_chrome.md) | Browser Home 使用沉浸式浏览器 chrome |
| [0006_browser_topbar_search_toolbox_windows.md](doc-src/decisions/0006_browser_topbar_search_toolbox_windows.md) | 浏览器顶栏、全屏搜索、浏览器菜单与窗口重构决策 |
| [0007_professional_browser_theme.md](doc-src/decisions/0007_professional_browser_theme.md) | 固定 Kiyori 主题、设置视觉与浏览器保护色域 |

## docs/doc-src/dev-core

| 文档 | 用途或标题 |
| --- | --- |
| [AI_CONVERSATION_AUDIT.md](doc-src/dev-core/AI_CONVERSATION_AUDIT.md) | AI 对话详情与完整审计 |
| [BUILDING.md](doc-src/dev-core/BUILDING.md) | Kiyori Android 构建指南 |
| [CONTRIBUTING.md](doc-src/dev-core/CONTRIBUTING.md) | Kiyori 贡献指南 |
| [FFMPEG_ARCHITECTURE.md](doc-src/dev-core/FFMPEG_ARCHITECTURE.md) | Kiyori FFmpeg 架构与开发指南 |
...
| 文档 | 用途或标题 |
| --- | --- |
| [chat_import_markdown.md](doc-src/feature-protocol/chat_import_markdown.md) | Markdown 聊天记录导入格式说明 |
| [external_http_chat.md](doc-src/feature-protocol/external_http_chat.md) | 外部 HTTP 对话接口 |
| [external_intent_chat.md](doc-src/feature-protocol/external_intent_chat.md) | 外部 Intent 对话接口：`EXTERNAL_CHAT` |
| [tool_permissions.md](doc-src/feature-protocol/tool_permissions.md) | AI 工具权限说明 |
| [toolcall_xml_conversion.md](doc-src/feature-protocol/toolcall_xml_conversion.md) | Tool Call 与 XML 内部协议说明（项目现状） |
| [workflow_intent_trigger.md](doc-src/feature-protocol/workflow_intent_trigger.md) | Workflow Intent 触发（自定义 Action） |

## docs/doc-src/package-dev

| 文档 | 用途或标题 |
| --- | --- |
| [android.md](doc-src/package-dev/android.md) | API 文档：`android.d.ts` |
| [chat.md](doc-src/package-dev/chat.md) | API 文档：`chat.d.ts` |
| [core.md](doc-src/package-dev/core.md) | API 文档：`core.d.ts` |
| [cryptojs.md](doc-src/package-dev/cryptojs.md) | API 文档：`cryptojs.d.ts` |
| [ffmpeg.md](doc-src/package-dev/ffmpeg.md) | API 文档：`ffmpeg.d.ts` |
| [files.md](doc-src/package-dev/files.md) | API 文档：`files.d.ts` |
| [index.md](doc-src/package-dev/index.md) | API 文档：`index.d.ts` |
| [jimp.md](doc-src/package-dev/jimp.md) | API 文档：`jimp.d.ts` |
| [memory.md](doc-src/package-dev/memory.md) | API 文档：`memory.d.ts` |
| [network.md](doc-src/package-dev/network.md) | API 文档：`network.d.ts` |
| [okhttp.md](doc-src/package-dev/okhttp.md) | API 文档：`okhttp.d.ts` |
| [results.md](doc-src/package-dev/results.md) | API 文档：`results.d.ts` |
| [software_settings.md](doc-src/package-dev/software_settings.md) | API 文档：`software_settings.d.ts` |
| [system.md](doc-src/package-dev/system.md) | API 文档：`system.d.ts` |
| [tasker.md](doc-src/package-dev/tasker.md) | API 文档：`tasker.d.ts` |
| [tool-types.md](doc-src/package-dev/tool-types.md) | API 文档：`tool-types.d.ts` |
| [toolpkg.md](doc-src/package-dev/toolpkg.md) | API 文档：`toolpkg.d.ts` |
| [ui.md](doc-src/package-dev/ui.md) | API 文档：`ui.d.ts` |
| [workflow.md](doc-src/package-dev/workflow.md) | API 文档：`workflow.d.ts` |

## docs/doc-src/research

| 文档 | 用途或标题 |
| --- | --- |
| [mnn_toolcall_research.md](doc-src/research/mnn_toolcall_research.md) | MNN Tool Call 调研记录 |

## docs/doc-src/test-example

| 文档 | 用途或标题 |
| --- | --- |
| [chat_import_markdown_example.md](doc-src/test-example/chat_import_markdown_example.md) | Python 编程讨论 |
| [toolpkg_probe_timing_breakdown.md](doc-src/test-example/toolpkg_probe_timing_breakdown.md) | ToolPkg 探针耗时分析 |
...
| 文档 | 用途或标题 |
| --- | --- |
| [README.md](../dragonbones/README.md) | DragonBones 模块 |

## examples

| 文档 | 用途或标题 |
| --- | --- |
| [README.md](../examples/README.md) | 脚本与 ToolPkg 开发示例 |

## examples/apktool/resources/apktool

| 文档 | 用途或标题 |
| --- | --- |
| [README.md](../examples/apktool/resources/apktool/README.md) | APK 逆向工具运行资源 |

## examples/custom_ai_provider
...
| 文档 | 用途或标题 |
| --- | --- |
| [README.md](../examples/template_try/resources/workspaces/quick_start/README.md) | Template Try |

## examples/toolpkg_wasm_demo

| 文档 | 用途或标题 |
| --- | --- |
| [README.md](../examples/toolpkg_wasm_demo/README.md) | ToolPkg WASM 示例 |

## examples/windows_control/resources/pc_agent

| 文档 | 用途或标题 |
| --- | --- |
| [README.md](../examples/windows_control/resources/pc_agent/README.md) | Windows 代理资源 |

## examples/windows_control/resources/pc_agent/kiyori-pc-agent
...
| 文档 | 用途或标题 |
| --- | --- |
| [UPSTREAM_SABA_VIEWER_MAPPING.md](../mmd/UPSTREAM_SABA_VIEWER_MAPPING.md) | Saba Viewer Android 映射 |

## quickjs

| 文档 | 用途或标题 |
| --- | --- |
| [README.md](../quickjs/README.md) | quickjsjni |
...
| 文档 | 用途或标题 |
| --- | --- |
| [JS_ADB_README.md](../tools/adb/JS_ADB_README.md) | ADB JavaScript Executor |
| [JS_ADB_README_zh.md](../tools/adb/JS_ADB_README_zh.md) | ADB JavaScript 执行与调试说明 |

## tools/compose_dsl

| 文档 | 用途或标题 |
| --- | --- |
| [COMPOSE_DSL_DEBUG_README.md](../tools/compose_dsl/COMPOSE_DSL_DEBUG_README.md) | Compose DSL 界面转储 |
| [README.md](../tools/compose_dsl/README.md) | Compose DSL 制品生成器 |
...
| 文档 | 用途或标题 |
| --- | --- |
| [AGENTS.md](../AGENTS.md) | Kiyori 开发协作准则 |
| [CONTEXT.md](../CONTEXT.md) | Kiyori 项目上下文 |
| [README.en.md](../README.en.md) | Kiyori |
| [README.md](../README.md) | Kiyori |

## 历史证据

旧 TODO 总索引的逐项证据集中在 [历史目录](TODO/history/README.md)，不与当前计划重复列出。
