...
- 设置首页保留固定复刻布局和 `4/4/4/4` 密度，第一组为“账号连接 / AI助手 / 语音服务 / 小程序”，第二组末项统一为“文档阅读器”，最后一组为“界面定制 / 数据备份 / 开发手册 / 更多功能”；16 个入口的图标和色彩身份均互不重复。账号、AI、语音、浏览器、播放器、下载器、界面、数据和更多功能入口连接现有 owner；更多功能中的权限项复用原 `Screen.ShizukuCommands`，其余未实现入口没有导航副作用
